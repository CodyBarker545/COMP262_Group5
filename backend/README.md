...
- [backend/server.py](/GroupProject262/backend/server.py): HTTP server and API routes
- [backend/inference.py](/GroupProject262/backend/inference.py): model loading, preprocessing, and prediction logic
- [tests/test_backend.py](/GroupProject262/tests/test_backend.py): backend tests
